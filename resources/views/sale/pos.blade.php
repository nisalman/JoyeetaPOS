                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <span class="totals-title">{{'Card charge'}} <button type="button" class="btn btn-link btn-sm" data-toggle="modal" data-target="#order-tax"><i class="dripicons-document-edit"></i></button></span><span id="tax">0.00</span>
                                        </div>
<!--                                        <div class="col-sm-4">
