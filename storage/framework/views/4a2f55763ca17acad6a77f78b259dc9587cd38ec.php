    ...
    <div id="receipt-data">
        <div class="centered">
            <?php if($general_setting->site_logo): ?>
                <img src="<?php echo e(url('public/logo/logo.png')); ?>" height="60" width="60" style="margin:10px 0">
            <?php endif; ?>
            
            <h2><?php echo e($lims_biller_data->company_name); ?></h2>
            
            <p><?php echo e(trans('file.Address')); ?>: 'Rapa Plaza, 1 Rd No. 27, Dhaka 1207'
        ...
        <table>
            ...
            <tfoot>
                ...
                <tr>
                    <th colspan="2"><?php echo e(trans('file.Card charge')); ?></th>
