              ...
              <?php endif; ?>
                <li><a href="#disbursement" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-gear"></i><span>Disbursement</span></a>
                    <ul id="disbursement" class="collapse list-unstyled ">
                        <?php if($role->id <= 2): ?>
                            <li id="disburse-report-menu"><a id="disburse-report-link" href="<?php echo e(route('disbursement.set')); ?>">SET</a></li>
                            <li id="disburse-report-menu"><a href="<?php echo e(route('disbursement.batchList')); ?>">Batch List</a></li>
                            <li id="disburse-report-menu"><a href="<?php echo e(route('disbursement.history')); ?>">Disburse History</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
    ...
    <div class="page">
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="https://lion-coders.com" class="external">ekShop</a></p>
            </div>
          </div>
        </div>
      </footer>
